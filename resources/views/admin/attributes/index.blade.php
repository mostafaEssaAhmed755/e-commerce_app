                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="btn-group" role="group" aria-label="Second group">
                                        ...
                                        <a href="#" onclick="event.defaultPrevented; document.querySelector('#attribute-{{ $attribute->id }}').submit()" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i></a>
                                        <form id="attribute-{{ $attribute->id }}" method="POST" action="{{ route('admin.attributes.destroy', $attribute->id) }}" style="display: none">@csrf @method('DELETE')</form>
                                    </div>
                                </td>
                            </tr>
                        @endforeach
