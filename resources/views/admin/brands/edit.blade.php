                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <input class="form-control @error('logo') is-invalid @enderror" onchange="document.querySelector('#brandLogo').src = window.URL.createObjectURL(this.files[0])" type="file" id="logo" name="logo"/>
