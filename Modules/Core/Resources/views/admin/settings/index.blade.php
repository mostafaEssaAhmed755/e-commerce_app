        ...
        <div class="col-md-9">
            <div class="tab-content">
                <div class="tab-pane active" id="general">
                    @include('core::admin.settings.includes.general')
                </div>
                <div class="tab-pane fade" id="site-logo">
                    @include('core::admin.settings.includes.logo')
                </div>
                <div class="tab-pane fade" id="footer-seo">
                    @include('core::admin.settings.includes.footer_seo')
                </div>
                <div class="tab-pane fade" id="social-links">
                    @include('core::admin.settings.includes.social_links')
                </div>
                <div class="tab-pane fade" id="analytics">
                    @include('core::admin.settings.includes.analytics')
                </div>
                <div class="tab-pane fade" id="payments">
                    @include('core::admin.settings.includes.payments')
                </div>
            </div>
        </div>
    </div>
