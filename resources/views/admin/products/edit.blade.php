...
@push('styles')
    <link rel="stylesheet" type="text/css" href="{{ asset('backend/js/plugins/dropzone/dropzone.min.css') }}"/>
@endpush
                                        ...
                                        <div class="col-md-3">
                                            <div class="card">
                                                <div class="card-body">
                                                    ...
                                                    <a href="#" onclick="event.defaultPrevented; document.querySelector('#productImage-{{ $image->id }}').submit()" class="card-link float-right text-danger">
                                                        <i class="fa fa-fw fa-lg fa-trash"></i>
                                                    </a>
                                                    <form id="productImage-{{ $image->id }}" method="POST" action="{{ route('admin.products.images.delete', $image->id) }}" style="display: none">@csrf @method('DELETE')</form>
                                                </div>
                                            </div>
                                        </div>
                                    @endforeach
...
@push('scripts')
    ...
    <script>
        ...
        $( document ).ready(function() {
            ...
            // dropzone to upload products images
